...
class CircleProgress1 extends CustomPainter {
  ...
  CircleProgress1(this.value, this.isTemp);
...
class CircleProgress2 extends CustomPainter {
  ...
  CircleProgress2(this.value, this.isTemp);
  ...
  void paint(Canvas canvas, Size size) {
    int maximumValue =
    isTemp ? 1024 : 100; // Temp's max is 50, Humidity's max is 100
    ...
    canvas.drawArc(Rect.fromCircle(center: center, radius: radius), -pi / 2,
        angle, false, isTemp ? lightArc : humidityArc);
  }
}